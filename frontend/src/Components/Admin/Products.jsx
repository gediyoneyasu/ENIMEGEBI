          ...
          return (
            <div key={product._id} className="product-card">
              ...
              <div className="product-info">
                <h3>{product.name}</h3>
                {product.nameAm && <p style={{ color: '#666', fontSize: '12px' }}>{product.nameAm}</p>}
        ...
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '700px' }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group"><label>Product Name (English) *</label><input type="text" name="name" value={formData.name} onChange={handleInputChange} required /></div>
              <div className="form-group"><label>Product Name (Amharic)</label><input type="text" name="nameAm" value={formData.nameAm} onChange={handleInputChange} /></div>
              ...
              <div className="form-group"><label>Price (ETB) *</label><input type="number" name="price" step="0.01" value={formData.price} onChange={handleInputChange} required /></div>
              ...
              <div className="form-group"><label>Seller/Farmer Name</label><input type="text" name="seller" value={formData.seller} onChange={handleInputChange} /></div>
